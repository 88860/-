...
protocol_edit_option5(){
  ...
  case $kind in
    ...
    tuic)
      ...
      while :; do case $(prompt "拥塞控制" "$(jq -r '.meta.congestion_control//"bbr"' "$file")") in 1|cubic) value=cubic;break;;2|new_reno) value=new_reno;break;;3|bbr) value=bbr;break;;*) tell_warn "输入无效，请重新选择";;esac; done
