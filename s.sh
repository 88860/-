...
wg_default_address(){
  local role=$1
  if [ "$role" = server ]; then
    WG_IPV4="10.10.0.1/24"
    WG_IPV6="fd00:10::1/64"
    WG_PEER_IPV4="10.10.0.2"
    WG_PEER_IPV6="fd00:10::2"
  else
    WG_IPV4="10.10.0.2/24"
    WG_IPV6="fd00:10::2/64"
    WG_PEER_IPV4="10.10.0.1"
    WG_PEER_IPV6="fd00:10::1"
  fi
}
...
wg_client_add(){
  ...
  while :; do
    ipv4=$(prompt "隧道 IPv4" "10.10.0.2/24")
    { wg_valid_address "$ipv4" && [[ "$ipv4" != *:*/* ]]; } && break
    tell_warn "IPv4 地址无效"
  done
  while :; do
    ipv6=$(prompt "隧道 IPv6" "fd00:10::2/64")
