...
apply_config(){
  ...
  timeout 15 systemctl reload-or-restart sing-box >/dev/null 2>&1
...
case $1 in
  ...
  --reapply)
    ...
    timeout 15 systemctl reload sing-box 2>/dev/null || timeout 15 systemctl restart sing-box 2>/dev/null
    sync_bypass_rules
    sync_hopping_rules
    flock -u 9
    exit 0 ;;
