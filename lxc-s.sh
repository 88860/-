...
write_service(){
  # 使用 Alpine 原生 OpenRC 守护进程，并开启秒复活配置
...
check_tun_support() {
  ...
  # 深度穿透验证: 确保 LXC 宿主放行了 cgroup 接口权限，否则静默降级
